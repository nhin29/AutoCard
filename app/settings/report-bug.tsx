 ...
 * Report a Bug Screen
 * 
 * Allows users to report bugs with email, message, and optional document upload
 */
export default function ReportBugScreen() {
  ...
  const handleSend = () => {
    ...
    Alert.alert(
      'Bug Report Sent',
      'Thank you for reporting this bug. We will review it and get back to you soon.',
      [
        {
          text: 'OK',
          onPress: () => router.back(),
  ...
  return (
    <KeyboardAvoidingView
      ...
      <View style={[styles.header, { paddingTop: headerPaddingTop, paddingBottom: headerPaddingBottom, paddingHorizontal: horizontalPadding }]}>
        ...
        <Text style={[styles.headerTitle, { fontSize: headerTitleFontSize }]}>Report a bug</Text>
